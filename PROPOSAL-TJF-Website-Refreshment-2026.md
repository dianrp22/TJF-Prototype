...
### Fase 1 — Discovery & Strategy (Minggu 3–4, Juni 2026)
- Kajian mendalam terhadap website TJF saat ini: audit konten, struktur, performa, dan gap analisis
- Wawancara dan diskusi dengan tim TJF untuk memahami kebutuhan, audiens, dan prioritas
- Benchmarking terhadap platform pengetahuan organisasi sejenis di tingkat nasional dan internasional
- Penyusunan rekomendasi strategis dan arah pengembangan

### Fase 2 — Arsitektur Informasi & UX (Minggu 4 Juni – Minggu 1 Juli 2026)
- Perancangan arsitektur informasi dan struktur navigasi website
- Penyusunan peta konten yang mengintegrasikan topik, riset, publikasi, inisiatif, dan berita
- Pembuatan wireframe dan prototype interaktif untuk review bersama tim TJF
- Validasi struktur dan alur pengguna (user flow)

### Fase 3 — Desain UI (Minggu 1–3, Juli 2026)
- Pengembangan desain antarmuka profesional yang selaras dengan identitas visual TJF
- Desain responsif untuk desktop, tablet, dan mobile
- Penyusunan design system dan komponen UI yang konsisten
- Review dan persetujuan desain bersama tim TJF

### Fase 4 — Pengembangan Website (Minggu 4 Juli – Minggu 3 Agustus 2026)
- Implementasi frontend dengan teknologi modern untuk performa dan SEO optimal
- Pengembangan sistem backend dan CMS yang intuitif untuk tim non-teknis TJF
- Integrasi fitur utama: knowledge center, sistem publikasi, manajemen konten multibahasa (Indonesia & Inggris)
- Integrasi Google Analytics 4 dan optimasi SEO on-page
- Setup pengalihan (301 redirect) dari URL website lama ke website baru

### Fase 5 — Pengujian & Penyempurnaan (Minggu 4 Agustus – Minggu 1 September 2026)
- Pengujian fungsionalitas, responsivitas, dan performa lintas perangkat dan browser
- User testing bersama tim TJF
- Penyempurnaan berdasarkan umpan balik

### Fase 6 — Peluncuran & Serah Terima (Minggu 2–3 September 2026)
- Migrasi konten dari website lama
- Peluncuran website resmi
- Pelatihan pengelolaan website dan analitik untuk tim TJF
- Serah terima dokumentasi teknis dan panduan pengelolaan konten
- Dukungan pasca-peluncuran selama 30 hari

---

## D. Rencana Kerja dan Timeline

| Fase | Kegiatan | Juni | Juli | Agustus | September |
|------|----------|:----:|:----:|:-------:|:---------:|
| 1 | Discovery & Strategy | M3–M4 | | | |
| 2 | Arsitektur Informasi & UX | M4 | M1 | | |
| 3 | Desain UI | | M1–M3 | | |
| 4 | Pengembangan Website | | M4 | M1–M3 | |
| 5 | Pengujian & Penyempurnaan | | | M4 | M1 |
| 6 | Peluncuran & Serah Terima | | | | M2–M3 |
...
|-------|----------------|
| Project Manager | Koordinasi, komunikasi klien, manajemen timeline |
| UX/UI Designer | Arsitektur informasi, wireframe, desain antarmuka |
| Fullstack Developer | Pengembangan frontend, backend, dan CMS |
| SEO & Analytics | Optimasi SEO, migrasi redirect, setup Google Analytics 4 |
...
|----|----------|------------|
| 1 | Discovery, Audit & Strategi | 5.000.000 |
| 2 | Arsitektur Informasi & UX Design | 7.000.000 |
| 3 | UI Design & Design System | 8.000.000 |
| 4 | Pengembangan Frontend | 15.000.000 |
| 5 | Pengembangan Backend & CMS | 13.000.000 |
| 6 | Integrasi SEO & Google Analytics 4 | 3.000.000 |
| 7 | Pengujian (QA) & User Testing | 3.000.000 |
| 8 | Peluncuran, Pelatihan & Dokumentasi | 6.000.000 |
| | **Total** | **Rp 60.000.000** |

*Anggaran belum termasuk biaya hosting, domain, dan layanan pihak ketiga yang diperlukan setelah serah terima.*
