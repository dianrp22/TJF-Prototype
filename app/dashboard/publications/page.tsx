        ...
        <table className="w-full text-sm min-w-[500px]">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="text-left px-4 py-3 text-[11px] font-bold text-gray-400 uppercase tracking-wide hidden sm:table-cell">Tipe</th>
            ...
            {filtered.map(item=>{
              ...
              return(
                <tr key={item.id} className="hover:bg-gray-50/60 transition-colors">
                  ...
                  <td className="px-4 py-3 hidden sm:table-cell"><span className={`px-2 py-0.5 text-[10px] font-bold rounded-full ${catBadge[item.category]??"bg-gray-100 text-gray-500"}`}>{item.category}</span></td>
